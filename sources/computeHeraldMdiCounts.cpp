    ...
    (QVector<int> channelSeq, int start, int end, long long nbrCounts[][3])
{
    ...
    switch (channelMark) {
    case 0b000000'001100'110000: nbrCounts[0][0]++; break; // B- A- 2  1
    case 0b000000'101100'010000: nbrCounts[0][1]++; break; // B  A- 2  1
    case 0b100000'001100'010000: nbrCounts[0][2]++; break; // B+ A- 2  1
    case 0b000000'011100'100000: nbrCounts[1][0]++; break; // B- A  2  1
    case 0b000000'111100'000000: nbrCounts[1][1]++; break; // B  A  2  1
    case 0b100000'011100'000000: nbrCounts[1][2]++; break; // B+ A  2  1
    case 0b010000'001100'100000: nbrCounts[2][0]++; break; // B- A+ 2  1
    case 0b010000'101100'000000: nbrCounts[2][1]++; break; // B  A+ 2  1
    case 0b110000'001100'000000: nbrCounts[2][2]++; break; // B+ A+ 2  1
...
//        int flag = (sample & 0x80000000) >> 31;      //“sample”值右移31位为flag位
        ...
        if (channel > 2 and channel < 7)                        // Channel=1-6 are the physical channels;

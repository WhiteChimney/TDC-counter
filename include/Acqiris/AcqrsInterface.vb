...
Module AcqrsInterface
    '/////////////////////////////////////////////////////////////////////////////////////////
    '
    '  AcqrsInterface.vb : Declaration of Acqiris device driver API for Visual Basic Dot Net
    '----------------------------------------------------------------------------------------
    '  Copyright (C) 2007, 2007-2010 Agilent. All rights reserved.
    '
    '/////////////////////////////////////////////////////////////////////////////////////////
    '  $Rev: 38648 $                  $Date: 2010-03-22 10:04:39 +0100 (Mon, 22 Mar 2010) $
    ...
    Alias "_Acqrs_calibrate@4" (ByVal instrumentID As Int32) As Int32
    ' Performs an auto-calibration of the instrument
    ' Equivalent to Acqrs_calibrateEx with 'calType' = 0

    public declare function Acqrs_calibrateCancel Lib "AqDrv4" _
    alias "_Acqrs_calibrateCancel@4" (ByVal instrumentID As Int32) As Int32
    ...
    Alias "_Acqrs_calibrateEx@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function Acqrs_calLoad  Lib "AqDrv4" _
    Alias "_Acqrs_calLoad@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function Acqrs_calRequired Lib "AqDrv4" _
    Alias "_Acqrs_calRequired@12"(ByVal instrumentID As Int32, _
    ...
    Public Declare Function Acqrs_calSave Lib "AqDrv4" _
    Alias "_Acqrs_calSave@12" (ByVal instrumentID As Int32, _
                               ByVal filePathName As String, _
                               ByVal flags As Int32) As Int32
    ...
    Alias "_Acqrs_close@4" (ByVal instrumentID As Int32) As Int32
    ...
    Alias "_Acqrs_closeAll@0" () As Int32
    ...
    Alias "_Acqrs_configLogicDevice@16" (ByVal instrumentID As Int32, _
    ...
    Alias "_Acqrs_errorMessage@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function Acqrs_getChanDevType Lib "AqDrv4" _
    Alias "_Acqrs_getChanDevType@12" (ByVal instrumentID As Int32, _
                                      ByVal channel As Int32, _
    ...
    Alias "_Acqrs_getDevType@8" (ByVal instrumentID As Int32, _
                                 ByRef devTypeP As Int32) As Int32
    ...
    Alias "_Acqrs_getDevTypeByIndex@8" (ByVal deviceIndex As Int32, _
                                        ByRef devTypeP As Int32) As Int32
    ...
    Alias "_Acqrs_getInstrumentData@20" (ByVal instrumentID As Int32, _
    ...
    Alias "_Acqrs_getInstrumentInfo@12" (ByVal instrumentID As Int32, _
    ...
    Alias "_Acqrs_getNbrChannels@8" (ByVal instrumentID As Int32, _
    ...
    Alias "_Acqrs_getNbrInstruments@4" (ByRef nbrInstruments As Int32) As Int32
    ...
    Alias "_Acqrs_getVersion@12" (ByVal instrumentID As Int32, _
    ...
    Alias "_Acqrs_logicDeviceIO@28" (ByVal instrumentID As Int32, _
                                     ByVal deviceName As String, _
    ...
    Public Declare Function Acqrs_powerSystem Lib "AqDrv4" _
    Alias "_Acqrs_powerSystem@8" (ByVal state As Int32, _
                                  ByVal flags As Int32) As Int32
    ...
    Alias "_Acqrs_reset@4" (ByVal instrumentID As Int32) As Int32
    ...
    Alias "_Acqrs_resetMemory@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function Acqrs_resumeControl Lib "AqDrv4" _
    Alias "_Acqrs_resumeControl@4" (ByVal instrumentID As Int32) As Int32
    ...
    Alias "_Acqrs_setAttributeString@16" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
                                          ByVal name As String, _
    ...
    Alias "_Acqrs_setLEDColor@8" (ByVal instrumentID As Int32, ByVal color As Int32) As Int32
    ...
    Alias "_Acqrs_setSimulationOptions@4" (ByVal simOptionString As String) As Int32
    ...
    Public Declare Function Acqrs_suspendControl Lib "AqDrv4" _
    Alias "_Acqrs_suspendControl@4" (ByVal instrumentID As Int32) As Int32

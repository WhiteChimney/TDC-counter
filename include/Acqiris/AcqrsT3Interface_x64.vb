...
Module AcqrsT3Interface_x64
    '/////////////////////////////////////////////////////////////////////////////////////////
    '
    '  AcqrsT3Interface_x64.vb : Declaration of Acqiris device driver API 
    ...
    Public Declare Function AcqrsT3_acqDone Lib "AqDrv4_x64" _
    Alias "AcqrsT3_acqDone" (ByVal instrumentID As Int32, _
                                ByRef doneP As Boolean) As Int32


    ' Starts an acquisition.
    Public Declare Function AcqrsT3_acquire Lib "AqDrv4_x64" _
    Alias "AcqrsT3_acquire" (ByVal instrumentID As Int32) As Int32
    ...
    '
    Public Declare Function AcqrsT3_configAcqConditions Lib "AqDrv4_x64" _
    Alias "AcqrsT3_configAcqConditions" (ByVal instrumentID As Int32, _
    ...
    '  'reserved' = unused, must be 0
    '    
    Public Declare Function AcqrsT3_configChannel Lib "AqDrv4_x64" _
    Alias "AcqrsT3_configChannel" (ByVal instrumentID As Int32, _
    ...
    '
    Public Declare Function AcqrsT3_configControlIO Lib "AqDrv4_x64" _
    Alias "AcqrsT3_configControlIO" (ByVal instrumentID As Int32, _
    ...
    '  'reserved'     = unused, must be 0
    '    
    Public Declare Function AcqrsT3_configMemorySwitch Lib "AqDrv4_x64" _
    Alias "AcqrsT3_configMemorySwitch" (ByVal instrumentID As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_configMode Lib "AqDrv4_x64" _
    Alias "AcqrsT3_configMode" (ByVal instrumentID As Int32, _
                                    ByVal mode As Int32, _
    ...
    '
    Public Declare Function AcqrsT3_forceTrig Lib "AqDrv4_x64" _
    Alias "AcqrsT3_forceTrig" (ByVal instrumentID As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_getAcqConditions Lib "AqDrv4_x64" _
    Alias "AcqrsT3_getAcqConditions" (ByVal instrumentID As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_getChannel Lib "AqDrv4_x64" _
    Alias "AcqrsT3_getChannel" (ByVal instrumentID As Int32, _
                                    ByVal channel As Int32, _
    ...
    '
    Public Declare Function AcqrsT3_getControlIO Lib "AqDrv4_x64" _
    Alias "AcqrsT3_getControlIO" (ByVal instrumentID As Int32, _
                                      ByVal connector As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_getMemorySwitch Lib "AqDrv4_x64" _
    Alias "AcqrsT3_getMemorySwitch" (ByVal instrumentID As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_getMode Lib "AqDrv4_x64" _
    Alias "AcqrsT3_getMode" (ByVal instrumentID As Int32, _
                                 ByRef modeP As Int32, _
    ...
    '    
    Public Declare Function AcqrsT3_readDataInt32 Lib "AqDrv4_x64" _
    Alias "AcqrsT3_readDataInt32" (ByVal instrumentID As Int32, _
                                    ByVal channel As Int32, _
    ...
    '    
    '
    Public Declare Function AcqrsT3_readDataReal64 Lib "AqDrv4_x64" _
    Alias "AcqrsT3_readDataReal64" (ByVal instrumentID As Int32, _
                                    ByVal channel As Int32, _
                                    ByRef readPar As AqT3ReadParametersInt32, _
                                    ByVal datArrayP As System.IntPtr, _
                                    ByRef dataDesc As AqT3DataDescriptorInt32) As Int32
    ...
    '
    Public Declare Function AcqrsT3_stopAcquisition Lib "AqDrv4_x64" _
    Alias "AcqrsT3_stopAcquisition" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsT3_waitForEndOfAcquisition Lib "AqDrv4_x64" _
    Alias "AcqrsT3_waitForEndOfAcquisition" (ByVal instrumentID As Int32, _

...
Public Module AcqrsD1Interface
    '/////////////////////////////////////////////////////////////////////////////////////////
    '
    '  AcqrsD1Interface.vb : Declaration of Acqiris device driver API 
    '  for Visual Basic Dot Net
    '----------------------------------------------------------------------------------------
    '  Copyright (C) 2007, 2007-2009 Agilent. All rights reserved.
    '
    '/////////////////////////////////////////////////////////////////////////////////////////
    ...
    Public Declare Function AcqrsD1_accumulateData Lib "AqDrv4" _
    Alias "_AcqrsD1_accumulateData@28" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_accumulateWform Lib "AqDrv4" _
    Alias "_AcqrsD1_accumulateWform@44" (ByVal instrumentID As Int32, _
                                         ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_acqDone Lib "AqDrv4" _
    Alias "_AcqrsD1_acqDone@8" (ByVal instrumentID As Int32, ByRef done As Boolean) As Int32
    ...
    Public Declare Function AcqrsD1_acquire Lib "AqDrv4" _
    Alias "_AcqrsD1_acquire@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_acquireEx Lib "AqDrv4" _
    Alias "_AcqrsD1_acquireEx@20" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_averagedData Lib "AqDrv4" _
    Alias "_AcqrsD1_averagedData@44" (ByVal instrumentID As Int32, _
                                      ByVal channel As Int32, _
                                      ByRef readPar As AqReadParameters, _
    ...
    Public Declare Function AcqrsD1_averagedWform Lib "AqDrv4" _
    Alias "_AcqrsD1_averagedWform@56" (ByVal instrumentID As Int32, _
                                       ByVal channel As Int32, _
                                       ByVal segmentNumber As Int32, _
                                       ByVal firstSample As Int32, _
                                       ByVal nbrSamples As Int32, _
    ...
    Public Declare Function AcqrsD1_bestNominalSamples Lib "AqDrv4" _
    Alias "_AcqrsD1_bestNominalSamples@8" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_bestSampInterval Lib "AqDrv4" _
    Alias "_AcqrsD1_bestSampInterval@24" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_calibrate Lib "AqDrv4" _
    Alias "_AcqrsD1_calibrate@4" (ByVal instrumentID As Int32) As Int32
    ' Performs an auto-calibration of the instrument
    ' Equivalent to AcqrsD1_calibrateEx with 'calType' = 0

    Public Declare Function AcqrsD1_calibrateEx Lib "AqDrv4" _
    Alias "_AcqrsD1_calibrateEx@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_close Lib "AqDrv4" _
    Alias "_AcqrsD1_close@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_closeAll Lib "AqDrv4" _
    Alias "_AcqrsD1_closeAll@0" () As Int32
    ' Closes all instruments and prepares for closing of application
    '
    ' Returns one of the following ViStatus values:
    ' VI_SUCCESS always.

    Public Declare Function AcqrsD1_configAvgConfig Lib "AqDrv4" _
    Alias "_AcqrsD1_configAvgConfig@16" (ByVal instrumentID As Int32, _
                                         ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_configAvgConfigInt32 Lib "AqDrv4" _
    Alias "_AcqrsD1_configAvgConfigInt32@16" (ByVal instrumentID As Int32, _
                                         ByVal channel As Int32, _
                                         ByVal parameterString As String, _
                                         ByRef value As Int32) As Int32
    ' Configures Averagers and Analyzer (APxxx)!
    ...
    Public Declare Function AcqrsD1_configAvgConfigReal64 Lib "AqDrv4" _
    Alias "_AcqrsD1_configAvgConfigReal64@20" (ByVal instrumentID As Int32, _
                                         ByVal channel As Int32, _
                                         ByVal parameterString As String, _
                                         ByRef value As Double) As Int32
    ' Configures Averagers and Analyzer (APxxx)!
    ...
    Public Declare Function AcqrsD1_configChannelCombination Lib "AqDrv4" _
    Alias "_AcqrsD1_configChannelCombination@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configControlIO Lib "AqDrv4" _
    Alias "_AcqrsD1_configControlIO@24" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configExtClock Lib "AqDrv4" _
    Alias "_AcqrsD1_configExtClock@36" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configFCounter Lib "AqDrv4" _
    Alias "_AcqrsD1_configFCounter@40" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configHorizontal Lib "AqDrv4" _
    Alias "_AcqrsD1_configHorizontal@20" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configLogicDevice Lib "AqDrv4" _
    Alias "_AcqrsD1_configLogicDevice@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configMemory Lib "AqDrv4" _
    Alias "_AcqrsD1_configMemory@12" (ByVal instrumentID As Int32, _
                                      ByVal nbrSamples As Int32, _
    ...
    Public Declare Function AcqrsD1_configMemoryEx Lib "AqDrv4" _
    Alias "_AcqrsD1_configMemoryEx@24" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configMode Lib "AqDrv4" _
    Alias "_AcqrsD1_configMode@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configMultiInput Lib "AqDrv4" _
    Alias "_AcqrsD1_configMultiInput@12" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_configSetupArray Lib "AqDrv4" _
    Alias "_AcqrsD1_configSetupArray@20" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_configTrigClass Lib "AqDrv4" _
    Alias "_AcqrsD1_configTrigClass@36" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_configTrigSource Lib "AqDrv4" _
    Alias "_AcqrsD1_configTrigSource@32" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_configTrigTV Lib "AqDrv4" _
    Alias "_AcqrsD1_configTrigTV@20" (ByVal instrumentID As Int32, _
                                      ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_configVertical Lib "AqDrv4" _
    Alias "_AcqrsD1_configVertical@32" (ByVal instrumentID As Int32, _
                                        ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_errorMessage Lib "AqDrv4" _
    Alias "_AcqrsD1_errorMessage@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_errorMessageEx Lib "AqDrv4" _
    Alias "_AcqrsD1_errorMessageEx@16" (ByVal instrumentID As Int32, _
                                        ByVal errorCode As Int32, _
    ...
    Public Declare Function AcqrsD1_forceTrig Lib "AqDrv4" _
    Alias "_AcqrsD1_forceTrig@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_forceTrigEx Lib "AqDrv4" _
    Alias "_AcqrsD1_forceTrigEx@16" (ByVal instrumentID As Int32, _
    ...
    public declare function AcqrsD1_freeBank Lib "AqDrv4" _
    Alias "_AcqrsD1_freeBank@8" (ByVal instrumentID As Int32, _
                                 ByVal reserved As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_getAvgConfig Lib "AqDrv4" _
    Alias "_AcqrsD1_getAvgConfig@16" (ByVal instrumentID As Int32, _
                                      ByVal channel As Int32, _
                                      ByVal parameterString As String, _
                                      ByRef value As Int32) As Int32
    Public Declare Function AcqrsD1_getAvgConfig Lib "AqDrv4" _
    ...
    Public Declare Function AcqrsD1_getAvgConfigInt32 Lib "AqDrv4" _
    Alias "_AcqrsD1_getAvgConfigInt32@16" (ByVal instrumentID As Int32, _
                                           ByVal channel As Int32, _
                                           ByVal parameterString As String, _
                                           ByRef value As Int32) As Int32
    ' Returns a parameter from the averager/analyzer configuration
    ...
    Public Declare Function AcqrsD1_getAvgConfigReal64 Lib "AqDrv4" _
    Alias "_AcqrsD1_getAvgConfigReal64@16" (ByVal instrumentID As Int32, _
                                            ByVal channel As Int32, _
                                            ByVal parameterString As String, _
                                            ByRef value As Double) As Int32
    ' Returns a parameter from the averager/analyzer configuration
    ...
    Public Declare Function AcqrsD1_getChannelCombination Lib "AqDrv4" _
    Alias "_AcqrsD1_getChannelCombination@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getControlIO Lib "AqDrv4" _
    Alias "_AcqrsD1_getControlIO@20" (ByVal instrumentID As Int32, _
                                      ByVal connector As Int32, _
    ...
    Public Declare Function AcqrsD1_getExtClock Lib "AqDrv4" _
    Alias "_AcqrsD1_getExtClock@24" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getFCounter Lib "AqDrv4" _
    Alias "_AcqrsD1_getFCounter@28" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getHorizontal Lib "AqDrv4" _
    Alias "_AcqrsD1_getHorizontal@12" (ByVal instrumentID As Int32, _
                                       ByRef sampInterval As Double, _
    ...
    Public Declare Function AcqrsD1_getInstrumentData Lib "AqDrv4" _
    Alias "_AcqrsD1_getInstrumentData@20" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getInstrumentInfo Lib "AqDrv4" _
    Alias "_AcqrsD1_getInstrumentInfo@12" (ByVal instrumentID As Int32, _
                                           ByVal parameterString As String, _
    ...
    Public Declare Function AcqrsD1_getMemory Lib "AqDrv4" _
    Alias "_AcqrsD1_getMemory@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getMemoryEx Lib "AqDrv4" _
    Alias "_AcqrsD1_getMemoryEx@24" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getMode Lib "AqDrv4" _
    Alias "_AcqrsD1_getMode@16" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getMultiInput Lib "AqDrv4" _
    Alias "_AcqrsD1_getMultiInput@12" (ByVal instrumentID As Int32, _
                                       ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_getNbrChannels Lib "AqDrv4" _
    Alias "_AcqrsD1_getNbrChannels@8" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getNbrPhysicalInstruments Lib "AqDrv4" _
    Alias "_AcqrsD1_getNbrPhysicalInstruments@4" (ByRef nbrInstruments As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_getSetupArray Lib "AqDrv4" _
    Alias "_AcqrsD1_getSetupArray@24" (ByVal instrumentID As Int32, _
                                       ByVal channel As Int32, _
                                       ByVal setupType As Int32, _
                                       ByVal nbrSetupObj As Int32, _
    ...
    Public Declare Function AcqrsD1_getTrigClass Lib "AqDrv4" _
    Alias "_AcqrsD1_getTrigClass@28" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getTrigSource Lib "AqDrv4" _
    Alias "_AcqrsD1_getTrigSource@24" (ByVal instrumentID As Int32, _
                                       ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_getTrigTV Lib "AqDrv4" _
    Alias "_AcqrsD1_getTrigTV@20" (ByVal instrumentID As Int32, _
                                   ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_getVersion Lib "AqDrv4" _
    Alias "_AcqrsD1_getVersion@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_getVertical Lib "AqDrv4" _
    Alias "_AcqrsD1_getVertical@24" (ByVal instrumentID As Int32, _
                                     ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_init Lib "AqDrv4" _
    ...
    Public Declare Function AcqrsD1_InitWithOptions Lib "AqDrv4" _
    ...
    Public Declare Function AcqrsD1_logicDeviceIO Lib "AqDrv4" _
    Alias "_AcqrsD1_logicDeviceIO@28" (ByVal instrumentID As Int32, _
                                       ByVal deviceName As String, _
    ...
    Public Declare Function AcqrsD1_multiInstrAutoDefine Lib "AqDrv4" _
    ...
    Public Declare Function AcqrsD1_multiInstrDefine Lib "AqDrv4" _
    Alias "_AcqrsD1_multiInstrDefine@16" (ByRef instrumentList As Int32, _
    ...
    Public Declare Function AcqrsD1_multiInstrUndefineAll Lib "AqDrv4" _
    Alias "_AcqrsD1_multiInstrUndefineAll@4" (ByVal optionsString As String) As Int32
    ...
    Public Declare Function AcqrsD1_processData Lib "AqDrv4" _
    Alias "_AcqrsD1_processData@12" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_procDone Lib "AqDrv4" _
    Alias "_AcqrsD1_procDone@8" (ByVal instrumentID As Int32, ByRef done As Boolean) As Int32
    ...
    Public Declare Function AcqrsD1_readCharSequence Lib "AqDrv4" _
    Alias "_AcqrsD1_readCharSequence@60" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
    ...
    Public Declare Function AcqrsD1_readCharWform Lib "AqDrv4" _
    Alias "_AcqrsD1_readCharWform@56" (ByVal instrumentID As Int32, _
                                  ByVal channel As Int32, _
                                  ByVal segmentNumber As Int32, _
                                  ByVal firstSample As Int32, _
                                  ByVal nbrSamples As Int32, _
    ...
    Public Declare Function AcqrsD1_readData Lib "AqDrv4" _
    Alias "_AcqrsD1_readData@24" (ByVal instrumentID As Int32, _
                                  ByVal channel As Int32, _
                                  ByRef readPar As AqReadParameters, _
                                  ByVal dataArray As System.IntPtr, _
                                  ByRef dataDesc As AqDataDescriptor, _
    ...
    Public Declare Function AcqrsD1_readFCounter Lib "AqDrv4" _
    Alias "_AcqrsD1_readFCounter@8" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_readRealSequence Lib "AqDrv4" _
    Alias "_AcqrsD1_readRealSequence@52" (ByVal instrumentID As Int32, _
                                          ByVal channel As Int32, _
                                          ByVal firstSegment As Int32, _
                                          ByVal nbrSegments As Int32, _
                                          ByVal firstSampleInSeg As Int32, _
    ...
    Public Declare Function AcqrsD1_readRealWform Lib "AqDrv4" _
    Alias "_AcqrsD1_readRealWform@44" (ByVal instrumentID As Int32, _
                                       ByVal channel As Int32, _
                                       ByVal segmentNumber As Int32, _
                                       ByVal firstSample As Int32, _
                                       ByVal nbrSamples As Int32, _
    ...
    Public Declare Function AcqrsD1_reportNbrAcquiredSegments Lib "AqDrv4" _
    Alias "_AcqrsD1_reportNbrAcquiredSegments@8" (ByVal instrumentID As Int32, _
                                                  ByRef nbrSegments As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_reset Lib "AqDrv4" _
    Alias "_AcqrsD1_reset@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_resetDigitizerMemory Lib "AqDrv4" _
    Alias "_AcqrsD1_resetDigitizerMemory@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_restoreInternalRegisters Lib "AqDrv4" _
    Alias "_AcqrsD1_restoreInternalRegisters@20" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_setAttributeString Lib "AqDrv4" _
    Alias "_AcqrsD1_setAttributeString@16" (ByVal instrumentID As Int32, _
                                            byval channel as int32, _
                                            byval name as string, _
    ...
    Public Declare Function AcqrsD1_setLEDColor Lib "AqDrv4" _
    Alias "_AcqrsD1_setLEDColor@8" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_setSimulationOptions Lib "AqDrv4" _
    Alias "_AcqrsD1_setSimulationOptions@4" (ByVal simOptionString As String) As Int32
    ...
    Public Declare Function AcqrsD1_stopAcquisition Lib "AqDrv4" _
    Alias "_AcqrsD1_stopAcquisition@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_stopProcessing Lib "AqDrv4" _
    Alias "_AcqrsD1_stopProcessing@4" (ByVal instrumentID As Int32) As Int32
    ...
    Public Declare Function AcqrsD1_waitForEndOfAcquisition Lib "AqDrv4" _
    Alias "_AcqrsD1_waitForEndOfAcquisition@8" (ByVal instrumentID As Int32, _
    ...
    Public Declare Function AcqrsD1_waitForEndOfProcessing Lib "AqDrv4" _
    Alias "_AcqrsD1_waitForEndOfProcessing@8" (ByVal instrumentID As Int32, _
                                               ByVal timeout As Int32) As Int32
